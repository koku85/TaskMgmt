  ...
  describe '検索機能' do
    ...
    context 'scopeメソッドでステータス検索をした場合' do
      it "ステータスに完全一致するタスクが絞り込まれる" do
        expect(Task.search_with_status('未着手')).to include(task)
        expect(Task.search_with_status('未着手')).not_to include(second_task)
